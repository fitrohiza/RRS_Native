  ...
  <div class="col">
    <div class="row-md-6 mb-3">
      <div class="card h-100">
        ...
        />
        <div class="card-body">
          <h4 class="card-title fw-bold mb-3">${data[0].title}</h4>
    ...
    <div class="row-md-6 mb-3">
      <div class="card h-100">
        ...
        />
        <div class="card-body">
          <h4 class="card-title fw-bold mb-3">${data[1].title}</h4>
            ...
            <div class="row g-0">
              ...
              <div class="col-md-8">
                <div class="card-body" style="display: flex;">
                  <div>
                    <h5 class="card-title" style="font-size: 14px ">${data[i].title}</h5>
    ...
    articleDetail.innerHTML = `
      <div class="card mb-5">
        ...
        <div class="card-body"><br>
          ...
          <p class="card-text" style="font-size: 16px">${data.content}</p>
